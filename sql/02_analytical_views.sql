...
DESCRIPTION:    Creates analytical views for Tableau consumption.
                1. vw_kpi_daily_store: Aggregates metrics at Day/Store level.
                2. vw_revenue_mix: Calculates percentage share per store.
